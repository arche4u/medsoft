  ...
  return (
    <div style={{ padding: "1.5rem", maxWidth: 1040, margin: "0 auto" }}>
      <div style={{ marginBottom: "1.1rem" }}>
        ...
        <p style={{ fontSize: "0.82rem", color: "#64748b" }}>IEC 62304 §5.7 system testing &amp; §5.8 software release — end-to-end test execution, requirement coverage, release readiness gates, configuration snapshots</p>
      </div>
