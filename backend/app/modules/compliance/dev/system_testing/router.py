...
async def get_readiness(release_id: str, db: AsyncSession = Depends(get_db)):
    from app.modules.compliance.release.model import Release
...
async def _compute_readiness(release_id: str, project_id: str, db: AsyncSession) -> ReleaseReadiness:
    ...
    from app.modules.compliance.dev.requirements.model import Requirement as _Req
    ...
    from app.modules.compliance.dev.integration_tests.router import get_coverage as itc_cov
    ...
    from app.modules.compliance.dev.units.model import SoftwareUnit
...
async def capture_snapshot(
    ...
    from app.modules.compliance.risk.risks.model import Risk
    from app.modules.compliance.dev.units.model import SoftwareUnit
    from app.modules.compliance.dev.architecture.model import SWComponent, SWInterface
