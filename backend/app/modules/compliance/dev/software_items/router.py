...
async def _run_compliance(
    ...
    from app.modules.compliance.risk.risks.model import RiskControl
    from app.modules.compliance.dev.architecture.model import SWComponent
    from app.modules.compliance.dev.system_testing.model import SystemTestCase, STAdditionalReqLink
    from app.modules.compliance.dev.units.model import SoftwareUnit, UnitTestCase, UnitRequirementLink
    from app.modules.compliance.dev.integration_tests.model import IntegrationTestCase, ITCRequirementLink
    ...
    if residual_required and risks:
        from app.modules.compliance.risk.risks.model import ResidualRisk
        risk_ids = [r.id for r in risks]
